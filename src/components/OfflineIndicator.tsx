...
export function OfflineIndicator({
    ...
    >
      {!isOnline ? (
        <>
          ...
          {backgroundSyncSupported && pendingCount > 0 && (
  ...
  // Add tooltip when offline with background sync
  if (!isOnline && backgroundSyncSupported && pendingCount > 0) {
    return (
      <AnimatePresence>
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              <p>Scores will sync automatically when back online, even if app is closed</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </AnimatePresence>
