...
- File-size violators (>500 lines): ✅ `FormatStep.tsx` **365** (was 1224, now under target), `Scorecard.tsx` 844 (was 1123), `NewRound.tsx` 1100, `RoundComplete.tsx` 976, `Stats.tsx` 833, `Profile.tsx` 831, `Home.tsx` 699.
